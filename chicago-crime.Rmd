...
autoplot(crime_ts) + ggtitle("Monthly Arrest Counts Over Time") + 
...
autoplot(train.ts) +
  autolayer(crime.comb.regression, series = "Regression Fit") +
  autolayer(valid.ts, series = "Observed") +
  ggtitle("Crime Rate Forecasting - Regression Fit") +
  ylab("Crime Rate") +
  xlab("Year")
```
